...
# #     cocotb_path = Path(result.stdout.strip())
# #     # cocotb_libs = cocotb_path / "libs"
# #     cocotb_libs = cocotb_path / "share" / "lib"
...
# #     return result.returncode
# def run_tests(test_module="test_spatiotemporal_classifier"):
#     """Run cocotb verification tests using Verilator."""
#     print_header("Running cocotb Verification Tests (Verilator)")
...
#     # ---- cocotb / simulator environment ----
#     env["TOPLEVEL"] = "uart_gesture_top"
#     env["MODULE"] = test_module
#     env["TOPLEVEL_LANG"] = "verilog"
#     env["COCOTB_SIM"] = "verilator"
#     env["PYTHONPATH"] = str(TB_DIR)
...
#     result = subprocess.run(verilator_cmd, env=env, cwd=build_dir)
#     if result.returncode != 0:
#         print_error("Verilator build failed")
#         return 1

#     sim_exe = build_dir / "simv"
#     if not sim_exe.exists():
#         print_error("Verilator simulator binary not produced")
#         return 1

#     print_success("Verilator build complete")
#     print("\nRunning simulation...")

#     result = subprocess.run([str(sim_exe)], env=env, cwd=build_dir)
